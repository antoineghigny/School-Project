package esi.atl.g56359.stibride.model.repository;

import esi.atl.g56359.stibride.model.dao.StopDao;
...
public class StopRepository implements Repository<Pair<Integer, Integer>, StopDto> {
    ...
    public List<StopDto> getAllNdStations() throws RepositoryException {
        return dao.selectAllNd();
    }
