...
public class View {
    ...
    public void showFavorite(String name) throws IOException {
        favoriteStage.show();
    ...
    public void changeLanguageComboBox(ObservableSet<StationDto> allStations) {
        ctrl.changeLanguage(allStations);
    }
}
